AFRAME.registerComponent("student-pool", {
    init() {
        ...
        setInterval(() => {
            ...
            let randomX = (Math.round(Math.random()) * 2 - 1) * (Math.floor(Math.random() * 5));
            console.log(randomX)
            let startX = randomX
            let endX = -randomX
            ...
            let animationString = "property:position; from: " + startX + " 2 " + startZ + "; to:" + endX + " 2 " + endZ + ";dur: 1000; easing:linear"
